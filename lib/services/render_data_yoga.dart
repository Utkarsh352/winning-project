...
class _RenderDataYogaState extends State<RenderDataYoga> {
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    shoulderAlignment = wristAlignment && leftWristY < leftShoulderY && rightWristY < rightShoulderY;

    ankleAlignment = leftAnkleX > 360 && rightAnkleX < 60;

    kneeAndHipAlignment = leftKneeY > 580 && leftHipY > 505;

    if (wristAlignment && shoulderAlignment && ankleAlignment && kneeAndHipAlignment) {
      setState(() {
