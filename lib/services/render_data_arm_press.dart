...
class _RenderDataArmPressState extends State<RenderDataArmPress> {
  ...
  double shoulderLY = 0;
  double shoulderRY = 0;
  double wristLX = 0, wristLY = 0, wristRX = 0, wristRY = 0, elbowLX = 0, elbowRX = 0;
  double kneeRY = 0, kneeLY = 0;
  bool squatUp = true;
  ...
  bool _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    return false; // Default return value to avoid error
  }
